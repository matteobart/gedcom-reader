...
class TestGedcomMethods(unittest.TestCase):
    ...
    def test_birthday_edge(self): # this test is RELATIVE to the actual day of code running
        ...
        p6 = Person("@20@", birthday=utils.parse_date("21 FEB 1961"), alive=True)
    ...
    def test_birth_before_death(self):
        try:
            ged_parser.parse(["0 @I32@ INDI", "1 BIRT Y", "2 DATE 6 MAY 1961", "1 DEAT Y", "2 DATE 6 MAY 1962",  "1 FAMS @F1@"])
        except Exception:
            self.fail("marriage_before_death() raised Exception unexpectedly!")
